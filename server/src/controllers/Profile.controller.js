...
export const updateProfile = asyncHandler(async (req, res) => {
    ...
    if (!firstName || !lastName || !color) {
        throw new ApiError(400, "First name, Last name and color are required")
    }
        ...
        const profile = await Profile.findByIdAndUpdate(profileId, { firstName, lastName, color, profileSetup: true, image:imageLink }, { new: true, runValidators: true })
        if (!profile) {
